...
void FileOpen(void)
{
	...
	fprintf(fp_char2,"         para1         para2          para3          para4          para5          para6          para7  **");
...
void OutputChara(void)							//特性データ出力
{
	...
	fprintf(fp_char1," %13.6f %13.6f **",PARA1,PARA2);
	...
	//      アンテナの研究を行う上で，必要以上の少数以下の桁数を出力していない．
	//      これ以上の桁数が必要ならば，任意出力を用いる
	fprintf(fp_char2," %13.6f %13.6f %13.6f %13.6f %13.6f %13.6f %13.6f **",PARA1,PARA2,PARA3,PARA4,PARA5,PARA6,PARA7);
